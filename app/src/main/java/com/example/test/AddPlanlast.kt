...
import com.example.test.databinding.ActivityAddPlanlastBinding
import java.time.LocalDate
import java.time.format.DateTimeFormatter
import java.util.Calendar
import java.util.Date

class AddPlanlast : AppCompatActivity() {
    private lateinit var binding: ActivityAddPlanlastBinding

    var departureDate: LocalDate? = null
    var endDate: LocalDate? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAddPlanlastBinding.inflate(layoutInflater)
